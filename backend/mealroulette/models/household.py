...
class HouseholdNotificationSubscription(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "household_id", name="uq_household_notification_subscriptions_user_household"),
    )
    ...
    notify_shopping: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    notify_roulette: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
