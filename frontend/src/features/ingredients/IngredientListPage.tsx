...
export function IngredientListPage() {
  const { accessToken, isAdmin, isHouseholdAdmin } = useAuth();
  ...
  const canBrowseTaxonomy = isAdmin || isHouseholdAdmin;
      ...
      >
        ...
        {!loading && !error && ingredients.length === 0 ? (
          <EmptyState
            ...
            action={!query && isAdmin ? <ButtonLink to="/ingredients/new">Add ingredient</ButtonLink> : undefined}
          />
        ) : null}
