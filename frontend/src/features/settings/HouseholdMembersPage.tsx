...
import { Button, PageShell, PageLoadingState, SettingsSectionHeader } from "../../components/ui";
import * as householdApi from "../../api/household";
import type { HouseholdInvitation, HouseholdMember } from "../../api/household";
...
function InviteLinkCell({ url }: { url: string | null }) {
  ...
  return (
    <div className="household-invite-link" role="group" aria-label="Invitation link">
      <code className="household-invite-link-code" title={inviteUrl}>
        {inviteUrl}
      </code>
      <button
        type="button"
...
export function HouseholdMembersPage() {
  ...
  async function handleRoleChange(membershipId: string, role: HouseholdMember["role"]) {
    if (!accessToken) {
      return;
    }
      ...
      <PageShell title="Household settings" subtitle="Name, invites, and member roles.">
        ...
        <section className="settings-section">
          <SettingsSectionHeader
            title="Household"
            description="Name shown in the app for everyone in this household."
          />
        ...
        <section className="settings-section">
          <SettingsSectionHeader
            title="Members"
            description="Active people in this household."
          />
